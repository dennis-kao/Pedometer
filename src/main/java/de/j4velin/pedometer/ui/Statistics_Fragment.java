...
public class Statistics_Fragment extends Fragment implements SensorEventListener {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (dailyStepsProgressBar == null) return;

        if (!isVisibleToUser) {
            dailyStepsProgressBar.stopDrawing();
        }
        else {
            dailyStepsProgressBar.startDrawing();
        }
    }
    ...
    public RealtimeCircularProgressBar getDailyStepsProgressBar() {
        return dailyStepsProgressBar;
    }
}

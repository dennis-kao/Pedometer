...
//        Fragment dayFragment = new Fragment_Day();
//        FragmentTransaction transaction = getChildFragmentManager().beginTransaction();
//        transaction.replace(R.id.day_Fragment, dayFragment).commit();
//    }
...
//        TextView textView = (TextView) getActivity().findViewById(R.id.step_history);
//        Button x = (Button) getActivity().findViewById(R.id.tab_layout);
//        x.setOnClickListener(new OnClickListener() {
//
//            @Override
//            public void onClick(View v) {
//                Intent firstpage= new Intent(getActivity(),Fragment_Day.class);

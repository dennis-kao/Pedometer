...
public class ShutdownRecevier extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        // set to true
        context.getSharedPreferences("de.dkao.de.dkao.pedometer", Context.MODE_PRIVATE).edit()
        ...
        if (db.getSteps(Util.getToday()) == Integer.MIN_VALUE) {
            ...
            int pauseDifference = steps -
                    context.getSharedPreferences("de.dkao.de.dkao.pedometer", Context.MODE_PRIVATE)
